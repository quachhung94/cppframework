...
class EVCCUdpClient : public CppServer::Asio::UDPClient
{
  public:
    //! Udp Client initialization
    EVCCUdpClient(const std::shared_ptr<CppServer::Asio::Service>& service, const std::string& address, int port, const std::string &interface);
